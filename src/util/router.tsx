...
import { HashRouter as RouterOriginal, RouteComponentProps, withRouter } from "react-router-dom";
...
const RouterContext = createContext<RouteComponentProps>({} as RouteComponentProps);
const RouterContextProvider = withRouter(({ children, ...routerProps }) => {
  return (
    <RouterContext.Provider value={{ history, ...routerProps }}>
      {children}
...
export { Route, Switch, Link, NavLink, Redirect } from "react-router-dom";
